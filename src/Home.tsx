      ...
      >
        ...
        <div className="mt-8 px-10 flex flex-col items-center w-full md:(flex-row flex-wrap items-start max-w-screen-xl)">
          ...
          <div className="flex flex-col w-full flex-shrink-0 p-3 md:w-1/2">
            ...
            <p>
              Because they're Flamingos, who doesn't like Flamingos especially these! OK, not only because of that, also because we are going to be DONATING 15%h of the launch to the homeless and because your supporting a young KID that spent a lot of time learning how to CODE, creating the Art and keeping up with the socials and much more all by himself.
              But wait, there is more! There will also be airdrops, special editions, and more... if you own a FM NFT
            </p>
          </div>
          <div className="flex flex-col w-full flex-shrink-0 p-3 md:w-1/2">
            <h1
